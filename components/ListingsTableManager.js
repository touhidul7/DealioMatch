              ...
              <tr key={row.id}>
                ...
                <td>
                  {editing ? (
                    ...
                    <div className="grid" style={{ gap: 6 }}>
                      <button className="button icon-btn" type="button" title="Edit listing" onClick={() => startEdit(row)}>
                        <FaEdit />
                      </button>
                      <button className="button icon-btn" type="button" title="Delete listing" onClick={() => deleteOne(row.id)}>
                        <FaTrash />
                      </button>
                    </div>
                  )}
